...
func TestMQ(t *testing.T) {
	...
	CreateTopic("test_mq_topic")

	// 2.生产者向主题中发送消息
	SendSyncMessage("生产者测试消息")
...
func SubcribeMessage() {
	...
	// 订阅topic
	err = c.Subscribe("test_mq_topic", consumer.MessageSelector{}, func(ctx context.Context, msgs ...*primitive.MessageExt) (consumer.ConsumeResult, error) {
		for i := range msgs {
